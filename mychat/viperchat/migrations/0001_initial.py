    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('masters_send_invitation_to_server', models.CharField(choices=[('Allowed', 'Allowed'), ('Forbidden', 'Forbidden')], default='Allowed', max_length=20)),
                ...
                ('moderators_send_invitation_to_server', models.CharField(choices=[('Allowed', 'Allowed'), ('Forbidden', 'Forbidden')], default='Allowed', max_length=20)),
                ...
                ('members_send_invitation_to_server', models.CharField(choices=[('Allowed', 'Allowed'), ('Forbidden', 'Forbidden')], default='Allowed', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('status', models.CharField(choices=[('waiting', 'waiting'), ('accepted', 'accepted'), ('declined', 'declined')], default='waiting', max_length=64)),
                ...
                ('server', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='viperchat.server')),
            ],
            options={
                'permissions': [('send_invitation', 'Can send invitations to private servers')],
            },
        ),
        migrations.AddField(
            model_name='server',
            name='permission_settings',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='viperchat.serverpermissionsettings'),
        ),
        migrations.AddField(
            model_name='server',
            name='users',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='viperchat.chat')),
